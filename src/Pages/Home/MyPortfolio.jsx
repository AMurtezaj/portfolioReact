    ...
    <section className="portfolio--section" id="MyPortfolio">
      ...
      <div className="portfolio--section--container">
        ...
        <div className="portfolio--section--card">
          <div className="portfolio--section--img">
            <img src="./img/placeholder-image.png" alt="Food Delivery System" />
          </div>
          <div className="portfolio--section--card--content">
            <div>
        ...
        <div className="portfolio--section--card">
          <div className="portfolio--section--img">
            <img src="./img/placeholder-image-1.png" alt="App Dashboard" />
          </div>
          <div className="portfolio--section--card--content">
            <div>
              <h3 className="portfolio--section--title">App Dashboard</h3>
              <p className="text-md">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique.
              </p>
            </div>
            <a
              href="https://github.com/yourusername/your-app-dashboard-repository"
              target="_blank"
              rel="noreferrer"
              className="text-sm portfolio--link"
            >
        ...
        <div className="portfolio--section--card">
          <div className="portfolio--section--img">
            <img src="./img/placeholder-image-2.png" alt="Easy Rentn" />
          </div>
          <div className="portfolio--section--card--content">
            <div>
              <h3 className="portfolio--section--title">Easy Rentn</h3>
              <p className="text-md">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique.
              </p>
            </div>
            <a
              href="https://github.com/yourusername/your-easy-rentn-repository"
              target="_blank"
              rel="noreferrer"
              className="text-sm portfolio--link"
            >
